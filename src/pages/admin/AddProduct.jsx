...
const AddProduct = () => {
    ...
    setFormData((prev) => ({
      ...
      [field]:
        field === "nutritionFacts"
          ? [
              ...prev[field],
              { nutrient: "", value: "", unit: "", percent: "", daily: "" },
            ]
          : field === "keyInsights"
  ...
  const handleFileUpload = async () => {
    ...
    try {
      ...
      setError(
        "Error uploading image: " + (err.message || "Unknown error occurred")
      );
      return null;
    } finally {
      setUploading(false);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { nutritionFacts, detailedBreakdown } =
        transformNutritionFactsToBreakdown(formData.nutritionFacts);
      const productData = {
        ...formData,
      ...
      await setDoc(
        doc(db, `products/config/${formData.category}`, docId),
        productData
      );
  ...
  const handleRemoveAddon = (addonId) => {
    addons.splice(
      addons.findIndex((addon) => addon.id === addonId),
      1
    );
    setAddons([...addons]);
  };
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="file-upload flex items-center">
                  <label
                    htmlFor="fileUpload"
                    className="flex-1 cursor-pointer px-4 py-2 bg-white border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
                  >
                  ...
                  <tr key={index}>
                    <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      >
                        ...
                        <option value="Total Carbohydrates">
                          Total Carbohydrates
                        </option>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <input
                        ...
                        value={fact.daily}
                        onChange={(e) =>
                          handleNutritionChange(index, "daily", e.target.value)
                        }
                        className="w-full px-3 py-1 border border-gray-300 rounded-md focus:ring-emerald-500 focus:border-emerald-500"
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      value={insight.title}
                      onChange={(e) =>
                        handleInsightChange(index, "title", e.target.value)
                      }
                      className="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-emerald-500 focus:border-emerald-500"
                    />
                  </div>
            ...
            addons.length > 0 ? (
              <div className="mt-8">
                ...
                <div className="list-disc space-y-2">
                  <div>
                    <h3  className="addOnHeads">Base</h3>
                    <div
                      style={{
                        marginLeft: "20px",
                        padding: "10px",
                    ...
                    >
                      {addons.filter((addon) => addon.type === "base").length >
                      0 ? (
                        addons
                          .filter((addon) => addon.type === "base")
                          .map((addon, index) => (
                            <div className="flex justify-between items-center w-100 p-2 rounded-md mb-2" style={
                                { backgroundColor: "rgba(0, 135, 85, 0.26)", borderRadius: "8px", border: "1px solid rgb(0, 135, 86)" }
                            }>
                              <span
                                key={index}
                  ...
                  <div>
                    <h3 className="addOnHeads">Toppings</h3>
                     <div
                      style={{
                        marginLeft: "20px",
                        padding: "10px",
                    ...
                    >
                      {addons.filter((addon) => addon.type === "topping").length >
                      0 ? (
                        addons
                          .filter((addon) => addon.type === "topping")
                          .map((addon, index) => (
                            <div className="flex justify-between items-center w-100 bg-gray-100 p-2 rounded-md mb-2" style={
                                { backgroundColor: "rgba(0, 135, 85, 0.26)", borderRadius: "8px", border: "1px solid rgb(0, 135, 86)" }
                            }>
                              <span
                                key={index}
                        ...
                        <p className="mt-2 text-sm text-gray-500">
                          No Topings available.
                        </p>
                      )}
                    </div>
                  </div>
                  <div>
                    <h3 className="addOnHeads">Boosters</h3>
                     <div
                      style={{
                        marginLeft: "20px",
                        padding: "10px",
                    ...
                    >
                      {addons.filter((addon) => addon.type === "booster").length >
                      0 ? (
                        addons
                          .filter((addon) => addon.type === "booster")
                          .map((addon, index) => (
                            <div className="flex justify-between items-center w-100 bg-gray-100 p-2 rounded-md mb-2" style={
                                { backgroundColor: "rgba(0, 135, 85, 0.26)", borderRadius: "8px", border: "1px solid rgb(0, 135, 86)" }
                            }>
