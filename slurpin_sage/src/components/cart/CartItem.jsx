...
const CartItem = ({ item, index }) => {
  ...
  const imageSrc =
    item.productId === 'morning-glory-smoothie'
      ? '/greensmoothie.jpg'
      : item.productId === 'berry-bliss'
      ? '/tropical.jpg'
      : '/greensmoothie.jpg';
    ...
    <div className="item_cartitem fade_in_global" style={{ animationDelay: `${index * 0.1}s` }}>
      <div className="item_container_cartitem">
        <div className="image_container_cartitem">
          <img src={imageSrc} alt={item.name} className="image_cartitem" />
        </div>
        <div className="details_cartitem">
          <div className="header_cartitem">
            <div>
              <h3 className="name_cartitem">{item.name}</h3>
              <p className="size_base_cartitem">{item.quantity > 1 ? 'Large' : 'Regular'} / {item.base}</p>
            </div>
            <div>
          ...
          {item.specialInstructions && (
            <div className="special_instructions_cartitem" onClick={handleEdit}>
              <div className="special_instructions_header_cartitem">
                <svg className="special_instructions_icon_cartitem" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="special_instructions_label_cartitem">Special Instructions</span>
                <svg className="special_instructions_edit_icon_cartitem" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
              </div>
              <div className="special_instructions_content_cartitem">
                <span className="special_instructions_text_cartitem">{item.specialInstructions}</span>
              </div>
            </div>
          )}
          <div className="actions_cartitem">
            <div className="quantity_container_cartitem">
              ...
              >
                <svg className="quantity_icon_cartitem" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="buttons_cartitem">
              <button
                className="edit_button_cartitem"
                onClick={handleEdit}
              >
                <svg className="action_icon_cartitem" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                </svg>
                Edit
              </button>
